!(function (e, r) {
  ...
  function v() {
    ...
    if (!f(r)) {
      ...
      r = l((r = r(e, t))).maskWithoutCaretTraps;
    }
    var o = t.guide,
      u = void 0 === o || o,
      ...
      g = t.placeholder,
      m = void 0 === g ? c(r, y) : g,
      b = t.currentCaretPosition,
      O = t.keepCharPositions,
      k = !1 === u && void 0 !== d,
      w = e.length,
      j = d.length,
      x = m.length,
  ...
  function j(e) {
    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : h;
    return null === e || Array.isArray(e) || "object" !== n(e)
      ? r
  ...
  function P(e) {
    ...
    x.partiallyUpdate(e, { previousValue: t });
  }
  function T(e, r, t) {
    var n = w(r, t);
    x.partiallyUpdate(e, { mask: n });
  }
  function V(e) {
  ...
  function S() {
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      r = j(e && e.placeholders);
    return function (e, t) {
      if (!k(e) && !Number.isFinite(e)) return e;
      var n = w(t, r);
      return v("".concat(e), n, { guide: !1 }).conformedValue;
    };
  }
  var C = S(),
    R = function (e) {
      ...
      (e.directive("mask", A(r)), e.filter("VMask", S(r)));
    };
